...
class CausalConformerVADAdapterBlock(torch.nn.Module):
    def __init__(
        self,
        input_size,
        ff_hidden_size,
        ...
        self.adapter = adapter.VADAdapter(input_size, adapter_hidden_size)
        # self.vad_loss = torch.nn.BCELoss(reduction="none")
